...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/+rGx8gQKYHuBmZjY1"),
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/+rGx8gQKYHuBmZjY1')
                ],[
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url=CHNL_LNK)
                  ],[
                    InlineKeyboardButton('⚠️DMCA⚠️', url="https://telegra.ph/DMCA-REPORT-12-23")
        ]]
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('Movie Channel', url='https://t.me/+RMtB0J2aYlJlMzc1')
                            ],
                            [
    ...
    if data.startswith("sendfiles"):
        ...
        g = f"https://kclplayer1.blogspot.com/https://telegram.me/{temp.U_NAME}?start=allfiles_{file_id}"
        k = await client.send_message(chat_id=message.from_user.id,text=f"<b>Get All Files in a Single Click!!!\n\n📂 ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 5 mins to avoid copyrights. Save the link to Somewhere else</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton('⁉️ Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ ⁉️', url="https://t.me/How_to_Open0")
                    ]
                ]
            )
        )
        ...
        files = files_[0]
        g = f"https://kclplayer1.blogspot.com/https://telegram.me/{temp.U_NAME}?start=file_{file_id}"
