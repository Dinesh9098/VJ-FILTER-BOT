...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        g = await get_shortlink(chat_id, f"https://kclplayer1.blogspot.com/https://telegram.me/{temp.U_NAME}?start=allfiles_{file_id}")
        ...
        files = files_[0]
        g = await get_shortlink(chat_id, f"https://kclplayer1.blogspot.com/https://telegram.me/{temp.U_NAME}?start=file_{file_id}")
