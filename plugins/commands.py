...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        g = f"https://kclplayer1.blogspot.com/telegram.me/{temp.U_NAME}?start=allfiles_{file_id}"
        ...
        files = files_[0]
        g = f"https://kclplayer1.blogspot.com/telegram.me/{temp.U_NAME}?start=file_{file_id}"
