...
URL = "https://ziyabot-bot45.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyabot-bot45.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyabot-bot45.koyeb.app/".format(FQDN)
else:
    URL = "https://ziyabot-bot45.koyeb.app/".format(FQDN)
