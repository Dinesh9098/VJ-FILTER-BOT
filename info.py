...
URL = "https://chhoraty.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://chhoraty.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://chhoraty.onrender.com/".format(FQDN)
else:
    URL = "https://chhoraty.onrender.com/".format(FQDN)
