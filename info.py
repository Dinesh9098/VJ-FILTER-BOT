...
URL = "https://findrrhj.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://findrrhj.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://findrrhj.onrender.com/".format(FQDN)
else:
    URL = "https://findrrhj.onrender.com/".format(FQDN)
