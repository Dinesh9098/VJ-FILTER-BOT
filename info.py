...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5646127927').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001618559675').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rajveer7111:Rajveerraj7111@cluster0.hormkep.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '8b05406c954d2e76788d71308f74fdd20b4c4cbb')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001908344985'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ZiyaSearchbot')
...
URL = "https://chhorat-58f6.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://chhorat-58f6.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://chhorat-58f6.onrender.com/".format(FQDN)
else:
    URL = "https://chhorat-58f6.onrender.com/".format(FQDN)
